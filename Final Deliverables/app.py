...
# Loading the model
model=load_model(r'C:\Users\HP\OneDrive\Desktop\IBM-Project-50098-1660892656-main (1)(1\IBM-Project-50098-1660892656-main\Project Development\Sprint 4\gesture.h5')
    ...
    if request.method == 'POST':
        ...
        while True:
            ...
            if prediction[0][0]=='ONE':
                ...
                center = (w // 2, h // 2)
                M = cv2.getRotationMatrix2D(center, 45, 1.0)
                rotated = cv2.warpAffine(image1, M, (200, 200))
